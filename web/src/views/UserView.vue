    ...
    >
      ...
      <div
        style="
          position: absolute;
          inset: 0;
          background: linear-gradient(0deg, var(--color-surface-base), transparent 60%);
        "
      ></div>

      <!-- Breadcrumb -->
      <div class="inner-wrap" style="position: absolute; top: 24px; left: 0; right: 0">
      ...
      >
        ...
        >
          ...
          <button
            ...
            "
            @mouseenter="
              ($event.currentTarget as HTMLElement).style.borderColor = 'var(--color-border-hover)'
            "
            @mouseleave="
