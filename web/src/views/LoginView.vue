...
const returnTo = route.query.redirect as string | undefined
</script>

<template>
  <div class="flex min-h-[calc(100vh-4rem)] flex-col items-center justify-center gap-8 px-6">
    <div class="flex flex-col items-center gap-2 text-center">
      <h1 class="font-heading text-4xl font-bold uppercase tracking-wide text-text-primary">
        Sign In
      </h1>
    ...
    <div class="flex w-full max-w-xs flex-col gap-3">
      ...
      <a
        ...
        class="flex items-center justify-center gap-3 rounded-md border border-border bg-surface-raised px-5 py-3 font-heading text-sm font-bold uppercase tracking-wider text-text-primary transition-colors duration-150 hover:border-border-hover hover:bg-surface-overlay"
      >
