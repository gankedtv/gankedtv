...
<template>
  <main class="page" style="max-width: 1440px; margin: 0 auto; padding: 32px 24px 120px">
    <!-- Page header -->
    <div>
      <div
        class="page-eyebrow"
        ...
        <div style="position: relative; overflow: hidden">
          ...
          <div
            style="
              position: absolute;
              inset: 0;
              background: linear-gradient(90deg, transparent 50%, var(--color-surface-raised) 100%);
            "
          ></div>
          <!-- Game badge -->
        ...
        >
          ...
          <div style="display: flex; align-items: center; gap: 12px">
            <button
              ...
              @click="router.push({ name: 'clip', params: { id: hero.id } })"
              @mouseenter="
                ($event.currentTarget as HTMLElement).style.background = 'var(--color-brand-light)'
              "
              @mouseleave="
                ($event.currentTarget as HTMLElement).style.background = 'var(--color-brand)'
              "
            >
              Watch Now
            </button>
            ...
            <button
              ...
              "
              @mouseleave="
                ($event.currentTarget as HTMLElement).style.borderColor = 'var(--color-border)'
              "
            >
