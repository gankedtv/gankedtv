...
const topClips = computed(() =>
  [...CLIPS].sort((a, b) => b.likes - a.likes).slice(0, 10),
)
...
<template>
  <main style="max-width: 1440px; margin: 0 auto; padding: 32px 24px 120px;">
    ...
    <div>
      <div
        style="font-family: var(--font-mono); font-size: 11px; color: var(--color-text-muted); letter-spacing: 0.1em; text-transform: uppercase; margin-bottom: 8px;"
      >
        Updated every 5 min · Ranked by likes + plays
      </div>
      <h1
        style="font-family: var(--font-heading); font-weight: 700; font-size: clamp(32px, 4vw, 52px); letter-spacing: 0.02em; text-transform: uppercase; margin: 0 0 20px; line-height: 1; color: var(--color-text-primary);"
      >
        Trending
      </h1>
      ...
      <!-- Time window toggle -->
      <div
        style="display: inline-flex; gap: 2px; padding: 4px; background: var(--color-surface-raised); border: 1px solid var(--color-border); border-radius: var(--radius-sm);"
      >
        <button
    ...
    <div class="trending-grid">
      ...
      <div
        style="background: var(--color-surface-raised); border: 1px solid var(--color-border); border-radius: var(--radius-md); overflow: hidden; margin-top: 28px;"
      >
        <div
          style="padding: 14px 16px; border-bottom: 1px solid var(--color-border);"
        >
          <span
            style="font-family: var(--font-heading); font-weight: 700; font-size: 14px; text-transform: uppercase; color: var(--color-text-secondary); letter-spacing: 0.05em;"
        ...
        <div
          ...
          style="display: grid; grid-template-columns: 60px 120px 1fr auto auto; gap: 16px; align-items: center; padding: 12px 16px; cursor: pointer; transition: background 150ms; border-bottom: 1px solid var(--color-border);"
        ...
        >
          ...
          <div style="position: relative; border-radius: 4px; overflow: hidden; aspect-ratio: 16/9;">
            ...
            />
            <span
              style="position: absolute; bottom: 4px; right: 4px; font-family: var(--font-mono); font-size: 10px; color: #fff; background: rgba(0,0,0,0.75); padding: 2px 5px; border-radius: 3px; line-height: 1;"
          ...
          <div style="min-width: 0; display: flex; flex-direction: column; gap: 4px;">
            <span
              style="font-family: var(--font-body); font-size: 13px; font-weight: 500; color: var(--color-text-primary); line-height: 1.35; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;"
            >{{ clip.title }}</span>
            <div style="display: flex; align-items: center; gap: 6px; font-family: var(--font-mono); font-size: 10px;">
              <span
                style="background: var(--color-surface-base); border: 1px solid var(--color-border-strong); border-radius: 3px; padding: 2px 6px; color: var(--color-text-secondary); text-transform: uppercase; letter-spacing: 0.06em;"
          ...
          <!-- Stats -->
          <div
            style="display: flex; flex-direction: column; gap: 4px; text-align: right; font-family: var(--font-mono); font-size: 11px; color: var(--color-text-secondary); white-space: nowrap;"
          >
      ...
      <div style="display: flex; flex-direction: column; gap: 16px; margin-top: 28px;">
        ...
        >
          <div style="padding: 14px 16px; border-bottom: 1px solid var(--color-border);">
            <span
              ...
              style="font-family: var(--font-heading); font-weight: 700; font-size: 14px; text-transform: uppercase; color: var(--color-text-secondary); letter-spacing: 0.05em; display: flex; align-items: center; gap: 10px;"
            >Top Creators</span>
          </div>
          ...
          <div
            ...
            :key="username"
            style="display: flex; align-items: center; gap: 12px; padding: 10px 16px; border-bottom: 1px solid var(--color-border); cursor: pointer; transition: background 150ms;"
            class="sidebar-row"
            @click="router.push({ name: 'user', params: { username } })"
          >
            <span
              style="font-family: var(--font-heading); font-weight: 700; font-size: 18px; color: var(--color-text-muted); width: 24px; flex-shrink: 0; line-height: 1;"
            >#{{ i + 1 }}</span>
            ...
            <div style="min-width: 0; flex: 1; display: flex; flex-direction: column; gap: 1px;">
              <span style="font-family: var(--font-body); font-size: 13px; font-weight: 500; color: var(--color-text-primary); white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
            ...
            <span style="font-family: var(--font-mono); font-size: 10px; color: var(--color-neon); white-space: nowrap; flex-shrink: 0;">
        ...
        >
          ...
          >
            <!-- Game art thumbnail -->
            <div style="width: 40px; height: 40px; border-radius: 4px; overflow: hidden; flex-shrink: 0; position: relative;">
              <img
                :src="game.art"
                alt=""
                style="width: 100%; height: 100%; object-fit: cover; display: block;"
            ...
            <div style="min-width: 0; flex: 1; display: flex; flex-direction: column; gap: 1px;">
              ...
              <span style="font-family: var(--font-mono); font-size: 10px; color: var(--color-neon);">
