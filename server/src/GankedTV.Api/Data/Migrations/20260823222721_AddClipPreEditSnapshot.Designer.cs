...
namespace GankedTV.Api.Data.Migrations
{
    ...
    [Migration("20260823222721_AddClipPreEditSnapshot")]
    partial class AddClipPreEditSnapshot
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GankedTV.Api.Data.Entities.Clip", b =>
                {
                    ...
                    b.Property<double?>("TrimEndSecs")
                        .HasColumnType("double precision")
                        .HasColumnName("trim_end_secs");

                    b.Property<double?>("TrimStartSecs")
                        .HasColumnType("double precision")
                        .HasColumnName("trim_start_secs");
                    ...
                    b.HasIndex("LikeCount", "ViewCount", "CreatedAt", "Id")
                        .IsDescending()
