...
/// <paramref name="AlternativeNames"/> is IGDB's alias list, which is how the importer still
/// recognises a game after an upstream rename. Null when the caller didn't request aliases.
/// </summary>
